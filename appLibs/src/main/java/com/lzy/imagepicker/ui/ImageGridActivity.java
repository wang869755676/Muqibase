...
public class ImageGridActivity extends BaseActivity implements
	...
	final public static int REQUEST_CODE_ASK_READ_EXTERNAL_STORAGE = 124;
	...
	public void onClick(View v) {
		...
		if (id == R.id.btn_ok) {
			...
			intent.putExtra(ImagePicker.EXTRA_IMAGE_ITEMS,
					imagePicker.getSelectedImages());
			ACache aCache = ACache.get(ImageGridActivity.this);
			aCache.put("pictureCache", (Serializable)imagePicker.getSelectedImages());
	...
	public void onImageItemClick(View view, ImageItem imageItem, int position) {
		...
		if (imagePicker.isMultiMode()) {
			ACache aCache = ACache.get(ImageGridActivity.this);
			aCache.put("pictureCache", (Serializable)imagePicker.getCurrentImageFolderItems());
			Intent intent = new Intent(ImageGridActivity.this,
					ImagePreviewActivity.class);
