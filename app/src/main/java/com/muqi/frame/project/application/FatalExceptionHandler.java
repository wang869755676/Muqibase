...
public class FatalExceptionHandler implements UncaughtExceptionHandler {
	...
	/** ExceptionHandler 实例 */
	private static FatalExceptionHandler INSTANCE;
	/** 程序的Context对象 */
	...
	public static FatalExceptionHandler getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new FatalExceptionHandler();
		}
		return INSTANCE;
	}
	...
	public void uncaughtException(Thread thread, Throwable ex) {
		if (!handleException(ex) && mDefaultHandler != null) {
			...
			mContext.stopService(new Intent("com.zlzk.tf.gps"));
